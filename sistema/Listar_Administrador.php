...
<?php include "includes/header.php";?>
    ...
    <table>
        <tr>
         ...
         <?php 
         //paginador
         $sql_register=mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM administrador WHERE estatus=1");
         ...
         $query=mysqli_query($conexion,"SELECT id_admin,nombre,apellido,cedula,correo,clave FROM administrador  WHERE estatus=1 ORDER BY id_admin ASC LIMIT $desde,$por_pagina");
