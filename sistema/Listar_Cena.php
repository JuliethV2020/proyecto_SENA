...
<?php include "includes/header.php";?>
    ...
    <table>
        <tr>
         ...
         <?php 
         //paginador
         $sql_register=mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM cena  WHERE estatus=1");
         ...
         $query=mysqli_query($conexion,"SELECT id_cena,nombre,precio,descripcion,foto FROM cena WHERE estatus=1 ORDER  BY id_cena ASC LIMIT $desde,$por_pagina");
