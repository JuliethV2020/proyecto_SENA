...
$query_insert=mysqli_query($conexion,"INSERT INTO desayuno (nombre,precio,descripcion,foto)VALUES('$nombre','$precio','$descripcion','$imgproducto')");
...
<head>
	...
	<title>REGISTRO DE DESAYUNOS</title>
</head>
<body>
<?php include "includes/header.php";?>
	<section id="container">
		<div class="form_register">
            <h1>REGISTRO DE  DESAYUNOS</h1>
            <hr>
            <div class="alert"><?php echo isset($alert)? $alert:'';?></div>
            <form action="Registro_Desayuno.php" method="post" enctype="multipart/form-data">
