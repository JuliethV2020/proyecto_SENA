...
if(empty($busqueda))
{
    header ("localhost:Listar_Desayuno.php");
...
<?php include "includes/header.php";?>
    ...
    <table>
        <tr>
         ...
         <?php 
         //paginador
         $sql_register=mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM desayuno WHERE (id_desayuno LIKE '%$busqueda%' OR 
         ...
         $query=mysqli_query($conexion,"SELECT id_desayuno,nombre,precio,descripcion,foto FROM desayuno WHERE 
         (id_desayuno LIKE '%$busqueda%' OR
          nombre LIKE '%$busqueda%' OR 
          precio LIKE '%$busqueda%' OR 
          descripcion LIKE '%$busqueda%')
         AND
         estatus=1 ORDER BY id_desayuno ASC LIMIT $desde,$por_pagina");
