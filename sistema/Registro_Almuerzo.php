...
$query_insert=mysqli_query($conexion,"INSERT INTO almuerzo (nombre,precio,descripcion,foto)VALUE('$nombre','$precio','$descripcion','$imgproducto')");
...
<head>
	...
	<title>REGISTRO DE ALMUERZO</title>
</head>
<body>
<?php include "includes/header.php";?>
	<section id="container">
		<div class="form_register">
            ...
            <form action="Registro_Almuerzo.php" method="post" enctype="multipart/form-data">
