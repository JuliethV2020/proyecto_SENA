...
<?php include "includes/header.php";?>
    ...
    <table>
        <tr>
         ...
         <?php 
         //paginador
         $sql_register=mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM bebidasfrias WHERE estatus=1");
         ...
         $query=mysqli_query($conexion,"SELECT id_frias,nombre,precio,descripcion,foto FROM bebidasfrias WHERE estatus=1 ORDER BY id_frias ASC LIMIT $desde,$por_pagina");
         ...
         <tr>
             ...
             <td>
                 <a  class="link_edit" href="Editar_Frias.php?id=<?php echo $data["id_frias"];?>">Editar</a>  ||
