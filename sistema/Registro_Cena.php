...
$query_insert=mysqli_query($conexion,"INSERT INTO cena (nombre,precio,descripcion,foto)VALUE('$nombre','$precio','$descripcion','$imgproducto')");
...
<head>
	...
	<title>REGISTRO DE CENA</title>
</head>
<body>
<?php include "includes/header.php";?>
	<section id="container">
		<div class="form_register">
            <h1>REGISTRO DE CENA</h1>
            <hr>
            <div class="alert"><?php echo isset($alert)? $alert:'';?></div>
            <form action="Registro_Cena.php" method="post" enctype="multipart/form-data">
